...
router.get('/overview', verifyJWT, ensureAdmin, async (req, res) => {
  try {
...
router.get('/getDomainStats', verifyJWT, ensureAdmin, async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error fetching domain stats', error: err.message });
  }
});
...
/*
=====================================
TIME SERIES (simple monthly count)
URL: /api/admin/getTimeSeriesStats
=====================================
*/
...
router.get('/getTimeSeriesStats', verifyJWT, ensureAdmin, async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error fetching time series stats', error: err.message });
  }
});
...
=====================================
TASK FUNNEL
URL: /api/admin/getTaskFunnelStats
=====================================
*/
...
router.get('/getTaskFunnelStats', verifyJWT, ensureAdmin, async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error fetching task funnel stats', error: err.message });
  }
});
...
=====================================
PENDING PAYMENTS
URL: /api/admin/getPendingPayments
=====================================
*/
...
=====================================
RELEASE PAYMENT
URL: /api/admin/releasePayment/:id
=====================================
*/
...
router.post('/releasePayment/:id', verifyJWT, ensureAdmin, async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Error releasing payment', error: err.message });
  }
});
