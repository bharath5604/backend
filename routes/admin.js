...
/*
=====================================
ADMIN CORE: USERS / TASKS / STUDENT DASHBOARD / PAYMENTS
=====================================
*/
...
/*
=====================================
HIGH-LEVEL ANALYTICS STATS (used by Flutter AdminDashboardScreen)
=====================================
*/
...
// Task analytics stats (for "Task analytics" section)
    ...
    const approvalAgg = await Task.aggregate([
      {
        $match: {
          ...
          status: { $in: ['assigned', 'under_review', 'completed'] },
        },
      },
      {
        $project: {
